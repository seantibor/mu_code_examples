...
start_color = input('What color do you want to start? ')
end_color = input('What color do you want to end? ')
num_sides = int(input('How many sides do you want?'))
num_shapes = 100
color_list = linear_gradient(start_color, end_color, num_shapes)
t.speed('fastest')
t.shape('turtle')
length = 100

for j in range(num_shapes):
    t.pencolor(color_list['hex'][j])
